...
namespace Core
{
    public class C140 : ClsChip
    {
        ...
        public int GetC140FNum(MML mml, partPage page, int octave, char noteCmd, int shift, int pitchShift)
        {
            try
            {
                int o = octave - 1;
        ...
        public override void SetFNum(partPage page, MML mml)
        {
            ...
            int f = GetC140FNum(mml, page, page.octaveNow, page.noteCmd, page.shift + page.keyShift + arpNote, page.pitchShift);//
        ...
        {
            return GetC140FNum(mml, page, octave, cmd, shift, pitchShift);
        }
