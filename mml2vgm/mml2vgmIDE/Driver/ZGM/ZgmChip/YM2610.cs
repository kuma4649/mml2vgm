...
namespace mml2vgmIDE.Driver.ZGM.ZgmChip
{
    ...
    {
        public YM2610(ChipRegister chipRegister, Setting setting, outDatum[] vgmBuf)
        {
        ...
        {
            chipRegister.YM2610SetRegister(od, Audio.DriverSeqCounter, Index, 1, vgmBuf[vgmAdr + 1].val, vgmBuf[vgmAdr + 2].val);
            vgmAdr += 3;
        }
