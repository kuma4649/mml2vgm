    ...
    public class dacControl_
    {
            ...
            switch (chip.DstChipType)
            {
                ...
                case 0x1B:  // HuC6280
                    ...
                    else
                    {
                        ...
                        // restore old channel
                        if (prevChn != Port)
                            chip_reg_write(Counter, chip.DstChipType, chip.DstChipID, 0x00, (byte)(Command >> 4), prevChn, od);
        ...
        public void update(long Counter, byte ChipID, uint samples)
        {
            ...
            if (samples > 0x20)
            {
                ...
                //NewPos = muldiv64round(NewPos * chip.DataStep, chip.Frequency, 44100);
            ...
            //NewPos = muldiv64round(chip.Step * chip.DataStep, chip.Frequency, 44100);
