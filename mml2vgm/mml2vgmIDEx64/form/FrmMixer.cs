        ...
        Action<bool, int>[] SetVolume = new Action<bool, int>[]
{
        ...
        public FrmMixer(FrmMain frm, int zoom, MDChipParams.Mixer newParam)
        {
            parent = frm;
            this.zoom = zoom;
        ...
        private void FrmMixer_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                parent.setting.location.RMixer = new Rectangle(Location.X, Location.Y, 0, 0);
            }
            else
            {
        ...
        private void FrmMixer_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            this.Location = new Point(parent.setting.location.RMixer.X, parent.setting.location.RMixer.Y);
        ...
        private void FrmMixer_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void FrmMixer_MouseMove(object sender, MouseEventArgs e)
        {
            int px = e.Location.X / parent.setting.other.Zoom;
            int py = e.Location.Y / parent.setting.other.Zoom;
            py = py % 72;
