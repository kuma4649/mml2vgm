    ...
    public partial class FrmMIDIKbd : Form
    {
        ...
        public FrmMIDIKbd(FrmMain frm, int zoom, MDChipParams.MIDIKbd newParam)
        {
            try
            {
                ...
                frameBuffer.Add(pbScreen, Resources.planeMIDIKB, null, zoom);
        ...
        {
            this.MaximumSize = new Size(frameSizeW + Resources.planeMIDIKB.Width * zoom, frameSizeH + Resources.planeMIDIKB.Height * zoom);
            this.MinimumSize = new Size(frameSizeW + Resources.planeMIDIKB.Width * zoom, frameSizeH + Resources.planeMIDIKB.Height * zoom);
            this.Size = new Size(frameSizeW + Resources.planeMIDIKB.Width * zoom, frameSizeH + Resources.planeMIDIKB.Height * zoom);
        ...
        private void Init()
        {
            string txt = Resources.tmpMIDIKbd;
            txt = string.Format(
                txt
