...
{
    public class SN76489X2 : Instrument
    {
        public SN76489X2(SoundManager.Chip chip, Setting setting, MIDIKbd midiKbd) : base(4, chip,setting,midiKbd)
        {
            for (int i = 0; i < 4; i++)
            {
                vol[i] = 15;
        ...
        public override string Name => "SN76489X2";
