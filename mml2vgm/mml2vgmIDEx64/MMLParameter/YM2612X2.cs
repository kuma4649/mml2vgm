...
{
    public class YM2612X2 : Instrument
    {

        public YM2612X2(SoundManager.Chip chip, Setting setting, MIDIKbd midiKbd) : base(24, chip,setting,midiKbd)
        {
            for (int i = 0; i < 24; i++)
            {
                vol[i] = 127;
        ...
        public override string Name => "YM2612X2";
