...
{
    public class YMF278B : ZgmChip
    {
        public YMF278B(ChipRegister chipRegister, Setting setting, outDatum[] vgmBuf) : base(18+5+24)
        {
        ...
        {
            chipRegister.YMF278BSetRegister(
                od
