...
{
    public class YM3812 : ZgmChip
    {
        public YM3812(ChipRegister chipRegister, Setting setting, outDatum[] vgmBuf) : base(14)
        {
        ...
        {
            chipRegister.YM3812SetRegister(od, Audio.DriverSeqCounter, Index, vgmBuf[vgmAdr + 1].val, vgmBuf[vgmAdr + 2].val);
            vgmAdr += 3;
        }
