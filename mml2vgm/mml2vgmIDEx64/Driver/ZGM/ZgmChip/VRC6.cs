...
{
    public class VRC6 : ZgmChip
    {
        public VRC6(ChipRegister chipRegister, Setting setting, outDatum[] vgmBuf) : base(3)
        {
        ...
        {
            chipRegister.VRC6SetRegister(od, Audio.DriverSeqCounter, Index, vgmBuf[vgmAdr + 1].val, vgmBuf[vgmAdr + 2].val);
            vgmAdr += 3;
        }
